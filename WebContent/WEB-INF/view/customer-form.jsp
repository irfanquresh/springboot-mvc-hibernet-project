				...
				<div class="col-xl-9">
					<div class="bd-content mb-5">
						...
						<div class="bd-example">
							<form:form action="saveForm" modelAttribute="customer"
								method="POST">
								<div class="form-group">
									<label for="form_first_name">First Name</label>
									<form:input path="firstName" type="text" class="form-control"
										id="form_first_name" placeholder="Enter First Name" />
								...
								<div class="form-group">
									...
									<form:input path="lastName" type="text" class="form-control"
										id="form_last_name" placeholder="Enter Last Name" />
								</div>
								...
								<div class="form-group">
									...
									<form:input path="email" type="text" class="form-control"
										id="form_email" placeholder="Enter Email" />
								</div>
